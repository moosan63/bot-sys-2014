...
# Usage:
# here is list
# http://sasuoni.herokuapp.com/yaml/sasuoni_images.yaml

# Hubot> さすおに :sasuoni
# Hubot> https://pbs.twimg.com/media/Bxk4earCAAE37Qp.jpg
#
# Hubot> :sasuoni
# Hubot> https://pbs.twimg.com/media/Bxk5iNwCUAAT3om.jpg
SASUONI_JSON_URL = "http://sasuoni.herokuapp.com/json"
...
module.exports = (robot) ->
    #robot.hear /^(.*?)\s*:sasuoni$/i, (msg) ->
        # key = msg.match[1]
        # if key?
        #     url = sasuoni_json[Math.floor(Math.random() * sasuoni[key].length)]
        #     msg.send url
        # else
    robot.hear /^:sasuoni$/i, (msg) ->    
